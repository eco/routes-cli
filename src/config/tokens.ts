...
export const TOKEN_CONFIGS: Record<string, TokenConfig> = {
    USDC: {
        ...
        addresses: {
            ...
            '10': AddressNormalizer.normalize('0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85', ChainType.EVM), // Optimism
            '8453': AddressNormalizer.normalize('0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', ChainType.EVM), // Base
            '84532': AddressNormalizer.normalize('0x036CbD53842c5426634e7929541eC2318f3dCF7e', ChainType.EVM), // Base Sepolia
            '11155420': AddressNormalizer.normalize('0x5fd84259d66Cd46123540766Be93DFE6D43130D7', ChainType.EVM), // Optimism Sepolia
            // Add more as needed
        },
    },
    USDT: {
        ...
        addresses: {
            ...
            '2494104990': AddressNormalizer.normalize('TKWwVSTacc9iToWgfef6cbkXPiBAKeSX2t', ChainType.TVM), // Tron Shasta
            // Add more as needed
        },
    },
};

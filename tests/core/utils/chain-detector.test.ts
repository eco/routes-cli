...
describe('ChainTypeDetector', () => {
  ...
  describe('isValidAddress', () => {
    it('should validate EVM addresses', () => {
      expect(ChainTypeDetector.isValidAddress('0x1234567890123456789012345678901234567890', ChainType.EVM)).toBe(true);
      expect(ChainTypeDetector.isValidAddress('0x123', ChainType.EVM)).toBe(false);
      expect(ChainTypeDetector.isValidAddress('1234567890123456789012345678901234567890', ChainType.EVM)).toBe(false);
    });

    it('should validate TVM addresses', () => {
      expect(ChainTypeDetector.isValidAddress('TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t', ChainType.TVM)).toBe(true);
      expect(ChainTypeDetector.isValidAddress('TR7', ChainType.TVM)).toBe(false);
      expect(ChainTypeDetector.isValidAddress('0x1234567890123456789012345678901234567890', ChainType.TVM)).toBe(false);
    });

    it('should validate SVM addresses', () => {
      expect(ChainTypeDetector.isValidAddress('11111111111111111111111111111112', ChainType.SVM)).toBe(true);
      expect(ChainTypeDetector.isValidAddress('EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v', ChainType.SVM)).toBe(true);
      expect(ChainTypeDetector.isValidAddress('123', ChainType.SVM)).toBe(false);
      expect(ChainTypeDetector.isValidAddress('0x1234567890123456789012345678901234567890', ChainType.SVM)).toBe(false);
    });
  });
});